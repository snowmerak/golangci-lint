...
import (
	...
	"github.com/snowmerak/golangci-lint/pkg/golinters"
	"github.com/snowmerak/golangci-lint/pkg/golinters/asasalint"
	"github.com/snowmerak/golangci-lint/pkg/golinters/asciicheck"
	"github.com/snowmerak/golangci-lint/pkg/golinters/bidichk"
	"github.com/snowmerak/golangci-lint/pkg/golinters/bodyclose"
	"github.com/snowmerak/golangci-lint/pkg/golinters/canonicalheader"
	"github.com/snowmerak/golangci-lint/pkg/golinters/containedctx"
	"github.com/snowmerak/golangci-lint/pkg/golinters/contextcheck"
	"github.com/snowmerak/golangci-lint/pkg/golinters/copyloopvar"
	"github.com/snowmerak/golangci-lint/pkg/golinters/cyclop"
	"github.com/snowmerak/golangci-lint/pkg/golinters/decorder"
	"github.com/snowmerak/golangci-lint/pkg/golinters/depguard"
	"github.com/snowmerak/golangci-lint/pkg/golinters/dogsled"
	"github.com/snowmerak/golangci-lint/pkg/golinters/dupl"
	"github.com/snowmerak/golangci-lint/pkg/golinters/dupword"
	"github.com/snowmerak/golangci-lint/pkg/golinters/durationcheck"
	"github.com/snowmerak/golangci-lint/pkg/golinters/err113"
	"github.com/snowmerak/golangci-lint/pkg/golinters/errcheck"
	"github.com/snowmerak/golangci-lint/pkg/golinters/errchkjson"
	"github.com/snowmerak/golangci-lint/pkg/golinters/errname"
	"github.com/snowmerak/golangci-lint/pkg/golinters/errorlint"
	"github.com/snowmerak/golangci-lint/pkg/golinters/execinquery"
	"github.com/snowmerak/golangci-lint/pkg/golinters/exhaustive"
	"github.com/snowmerak/golangci-lint/pkg/golinters/exhaustruct"
	"github.com/snowmerak/golangci-lint/pkg/golinters/exportloopref"
	"github.com/snowmerak/golangci-lint/pkg/golinters/fatcontext"
	"github.com/snowmerak/golangci-lint/pkg/golinters/forbidigo"
	"github.com/snowmerak/golangci-lint/pkg/golinters/forcetypeassert"
	"github.com/snowmerak/golangci-lint/pkg/golinters/funlen"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gci"
	"github.com/snowmerak/golangci-lint/pkg/golinters/ginkgolinter"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gocheckcompilerdirectives"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gochecknoglobals"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gochecknoinits"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gochecksumtype"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gocognit"
	"github.com/snowmerak/golangci-lint/pkg/golinters/goconst"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gocritic"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gocyclo"
	"github.com/snowmerak/golangci-lint/pkg/golinters/godot"
	"github.com/snowmerak/golangci-lint/pkg/golinters/godox"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gofmt"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gofumpt"
	"github.com/snowmerak/golangci-lint/pkg/golinters/goheader"
	"github.com/snowmerak/golangci-lint/pkg/golinters/goimports"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gomoddirectives"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gomodguard"
	"github.com/snowmerak/golangci-lint/pkg/golinters/goprintffuncname"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gosec"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gosimple"
	"github.com/snowmerak/golangci-lint/pkg/golinters/gosmopolitan"
	"github.com/snowmerak/golangci-lint/pkg/golinters/govet"
	"github.com/snowmerak/golangci-lint/pkg/golinters/grouper"
	"github.com/snowmerak/golangci-lint/pkg/golinters/importas"
	"github.com/snowmerak/golangci-lint/pkg/golinters/inamedparam"
	"github.com/snowmerak/golangci-lint/pkg/golinters/ineffassign"
	"github.com/snowmerak/golangci-lint/pkg/golinters/interfacebloat"
	"github.com/snowmerak/golangci-lint/pkg/golinters/intrange"
	"github.com/snowmerak/golangci-lint/pkg/golinters/ireturn"
	"github.com/snowmerak/golangci-lint/pkg/golinters/lll"
	"github.com/snowmerak/golangci-lint/pkg/golinters/loggercheck"
	"github.com/snowmerak/golangci-lint/pkg/golinters/maintidx"
	"github.com/snowmerak/golangci-lint/pkg/golinters/makezero"
	"github.com/snowmerak/golangci-lint/pkg/golinters/mirror"
	"github.com/snowmerak/golangci-lint/pkg/golinters/misspell"
	"github.com/snowmerak/golangci-lint/pkg/golinters/mnd"
	"github.com/snowmerak/golangci-lint/pkg/golinters/musttag"
	"github.com/snowmerak/golangci-lint/pkg/golinters/nakedret"
	"github.com/snowmerak/golangci-lint/pkg/golinters/nestif"
	"github.com/snowmerak/golangci-lint/pkg/golinters/nilerr"
	"github.com/snowmerak/golangci-lint/pkg/golinters/nilnil"
	"github.com/snowmerak/golangci-lint/pkg/golinters/nlreturn"
	"github.com/snowmerak/golangci-lint/pkg/golinters/noctx"
	"github.com/snowmerak/golangci-lint/pkg/golinters/nolintlint"
	"github.com/snowmerak/golangci-lint/pkg/golinters/nonamedreturns"
	"github.com/snowmerak/golangci-lint/pkg/golinters/nosprintfhostport"
	"github.com/snowmerak/golangci-lint/pkg/golinters/paralleltest"
	"github.com/snowmerak/golangci-lint/pkg/golinters/perfsprint"
	"github.com/snowmerak/golangci-lint/pkg/golinters/prealloc"
	"github.com/snowmerak/golangci-lint/pkg/golinters/predeclared"
	"github.com/snowmerak/golangci-lint/pkg/golinters/promlinter"
	"github.com/snowmerak/golangci-lint/pkg/golinters/protogetter"
	"github.com/snowmerak/golangci-lint/pkg/golinters/reassign"
	"github.com/snowmerak/golangci-lint/pkg/golinters/revive"
	"github.com/snowmerak/golangci-lint/pkg/golinters/rowserrcheck"
	"github.com/snowmerak/golangci-lint/pkg/golinters/sloglint"
	"github.com/snowmerak/golangci-lint/pkg/golinters/snowygo"
	"github.com/snowmerak/golangci-lint/pkg/golinters/spancheck"
	"github.com/snowmerak/golangci-lint/pkg/golinters/sqlclosecheck"
	"github.com/snowmerak/golangci-lint/pkg/golinters/staticcheck"
	"github.com/snowmerak/golangci-lint/pkg/golinters/stylecheck"
	"github.com/snowmerak/golangci-lint/pkg/golinters/tagalign"
	"github.com/snowmerak/golangci-lint/pkg/golinters/tagliatelle"
	"github.com/snowmerak/golangci-lint/pkg/golinters/tenv"
	"github.com/snowmerak/golangci-lint/pkg/golinters/testableexamples"
	"github.com/snowmerak/golangci-lint/pkg/golinters/testifylint"
	"github.com/snowmerak/golangci-lint/pkg/golinters/testpackage"
	"github.com/snowmerak/golangci-lint/pkg/golinters/thelper"
	"github.com/snowmerak/golangci-lint/pkg/golinters/tparallel"
	"github.com/snowmerak/golangci-lint/pkg/golinters/unconvert"
	"github.com/snowmerak/golangci-lint/pkg/golinters/unparam"
	"github.com/snowmerak/golangci-lint/pkg/golinters/unused"
	"github.com/snowmerak/golangci-lint/pkg/golinters/usestdlibvars"
	"github.com/snowmerak/golangci-lint/pkg/golinters/varnamelen"
	"github.com/snowmerak/golangci-lint/pkg/golinters/wastedassign"
	"github.com/snowmerak/golangci-lint/pkg/golinters/whitespace"
	"github.com/snowmerak/golangci-lint/pkg/golinters/wrapcheck"
	"github.com/snowmerak/golangci-lint/pkg/golinters/wsl"
	"github.com/snowmerak/golangci-lint/pkg/golinters/zerologlint"
